...
if __name__ == '__main__':
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        with torch.no_grad():
            ...
            fake_val_phase_images, fake_val_amp_images = netG(val_images)
            fake_val_amp_images=fake_val_amp_images.detach().cpu()
            fake_val_phase_images = fake_val_phase_images.detach().cpu()
