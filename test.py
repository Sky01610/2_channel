...
if __name__ == "__main__":
    model_path = "checkpoints/netG_epoch_15.pth"  # 训练好的生成器模型路径
    test_image_path = "dataset_restore/noisy/1.jpg"  # 测试图像路径
    output_path_amplitude = "results/1_amplitude.jpg"  # 输出振幅图像路径
    output_path_phase = "results/1_phase.jpg"  # 输出相位图像路径
